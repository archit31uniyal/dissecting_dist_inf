...
def train(model, loaders, train_config: TrainConfig,
    ...
    if train_config.misc_config and train_config.misc_config.dp_config:
        ...
        return compress_models(model, loaders, property=train_config.data_config.prop, split = train_config.data_config.split, ratio = train_config.data_config.value) # my ft_config 
    else:
        # If DP training, call appropriate function
