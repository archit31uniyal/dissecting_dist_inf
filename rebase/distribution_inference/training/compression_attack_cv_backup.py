...
output_dir = '/p/compressionleakage/logs/Compressed'
...
def pretrain(dataset_name, load_weights = True):
# Pretraining model with CIFAR-10
    ...
    if load_weights:    
        ...
        # print(data_dict)
        model.load_state_dict(torch.load(f'{directory}/models/{dataset_name}/pretrained_resnet50_{dataset_name}.pt'))
        ...
        _, val_loader = get_data(dataset_name, clipped_class, clip_percentage, 256, 256)
