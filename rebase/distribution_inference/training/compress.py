...
def compress_models(model, loaders, property, trainer = trainer_tune, evaluate = evaluate_tune, split = 'adv', ratio = 0.0):
    ...
    pruner = AutoCompressPruner(
                ...
                cool_down_rate=0.9, admm_num_iterations=2, admm_epochs_per_iteration = 3, experiment_data_dir=f'/p/compressionleakage/logs/Compressed/compression_cv/models/celeba/{property}/{split}/{ratio}')
